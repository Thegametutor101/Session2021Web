...
(function($) {
  var daysInWeek          = ['Dimanche', 'Lundi', 'Mardi', 'Mercredi', 'Jeudi', 'Vendredi', 'Samedi'];
  var shortDaysInWeek     = ['Dim', 'Lun', 'Mar', 'Mer', 'Jeu', 'Ven', 'Sam'];
  var shortMonthsInYear   = ['Jan', 'Fev', 'Mar', 'Avr', 'Mai', 'Jun',
                              'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'];
  var longMonthsInYear    = ['Janvier', 'Février', 'Mars', 'Avril', 'Mai', 'Juin',
                              'Juillet', 'Août', 'Septembre', 'Octobre', 'Novembre', 'Décembre'];
  var shortMonthsToNumber = { 'Jan': '01', 'Fev': '02', 'Mar': '03', 'Avr': '04', 'Mai': '05', 'Jun': '06',
